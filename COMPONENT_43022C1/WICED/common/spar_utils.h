...
#define SETUP_APP_FOR_DEBUG_IF_DEBUG_ENABLED()   do{		\
        watchdog_Init(0); \
        REG32(cr_pad_fcn_ctl_ajtag_adr) = (REG32(cr_pad_fcn_ctl_ajtag_adr) & ~0x0000FFFF) | 0x00008888; \
        REG32(cr_pad_config_adr4) = (REG32(cr_pad_config_adr4) & ~0x00FF00FF) | 0x00bd00bc; \
        REG32(cr_pad_fcn_ctl_adr1) = (REG32(cr_pad_fcn_ctl_adr1) & ~0x0F00F000) | 0x08008000; \
        REG32(cr_smux_ctl_adr6) = (REG32(cr_smux_ctl_adr6) & ~0x0000FFFF) | 0x0000100d; \
        REG32(cr_smux_ctl_adr3) = (REG32(cr_smux_ctl_adr3) & ~0x000000FF) | 0x00000024; \
	}while(0)
/// Optionally waits in a pseudo while(1) until the user allows the CPU to continue
#define BUSY_WAIT_UNTIL_MANUAL_CONTINUE_IF_DEBUG_ENABLED()     do{	\
...
#define BUSY_WAIT_UNTIL_MANUAL_CONTINUE_IF_DEBUG_ENABLED()
#endif
